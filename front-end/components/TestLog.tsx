...
const TestLog = forwardRef<ClearControlsHandle, TestLogProps>(
  ({ logsJson, isBusy, requestApiCall }, ref) => {
      ...
      <div className='flex h-full'>
        ...
        <div className='w-1/3 p-4 border-l flex flex-col'>
          <div className='flex justify-between mb-4 w-full'>
            ...
            />
            <button
              className={`px-4 py-2 text-sm bg-red-500 text-white rounded flex items-center 
                  ${
                    isBusy
